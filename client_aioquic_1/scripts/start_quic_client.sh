...
python /aioquic/examples/http3_client.py -k --secrets-log $PATH_KEYS --quic-log $PATH_QLOG --zero-rtt --session-ticket /shared/ticket.txt https://172.3.0.5:4433/echo 
