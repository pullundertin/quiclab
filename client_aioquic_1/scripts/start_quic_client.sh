...
python /aioquic/examples/http3_client.py -k https://172.3.0.5:4433/echo --secrets-log $PATH_KEYS --quic-log $PATH_QLOG --zero-rtt --output-dir /shared/ --session-ticket /shared/ticket.txt 2> /shared/errors.log &
pid1=$! & change_ip & 
wait $pid1
