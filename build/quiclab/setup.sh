...
run_and_log_command "apt install git cmake vim iperf3 python-is-python3 pip curl iputils-ping net-tools bc iproute2 ethtool libssl-dev python3-dev nginx tcpdump wget python3-psutil iptables -y"
